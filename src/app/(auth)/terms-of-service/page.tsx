          ...
          <Container className="max-w-6xl relative z-10">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Please read these terms carefully before using Juzbuild. By
          ...
          >
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                By accessing and using Juzbuild, you accept and agree to be
                ...
                Continued use of our service following modifications constitutes
            ...
            <section>
              ...
              <ul className="space-y-2 text-muted-foreground mb-4">
                <li>
                  • Access and use Juzbuild for personal and commercial purposes
                </li>
                <li>• Create and manage your real estate portfolio</li>
                <li>• Publish content and property listings on your website</li>
              </ul>
              <p className="text-muted-foreground leading-relaxed">
                You may not: modify, copy, distribute, or create derivative
                works of our service; attempt to reverse engineer or decompile
                any software; use the service for unlawful purposes; or
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                complete information. You are entirely responsible for:
              </p>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                You retain ownership of content you create and publish. By
                uploading content to Juzbuild, you grant us a worldwide,
                non-exclusive license to use, reproduce, modify, and distribute
                your content for service operation purposes.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                You represent and warrant that your content does not violate any
                third-party intellectual property rights, is not defamatory, and
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                <strong>AS-IS BASIS:</strong> Juzbuild is provided "as is"
                without warranties of any kind, express or implied, including
                merchantability, fitness for a particular purpose, or
                non-infringement.
              </p>
              <p className="text-muted-foreground leading-relaxed mb-4">
                <strong>SERVICE AVAILABILITY:</strong> We do not warrant that
                the service will be uninterrupted or error-free. We may perform
                maintenance or updates that temporarily affect availability.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                <strong>NO LIABILITY FOR INDIRECT DAMAGES:</strong> We are not
                liable for lost profits, lost data, or indirect, incidental,
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                Juzbuild shall not exceed the amount you paid us in the 12
                months preceding the claim. Some jurisdictions do not allow the
                exclusion of certain warranties or limitation of liability, so
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                You agree to indemnify and hold harmless Juzbuild, its founders,
                employees, and agents from any claims, damages, or costs
                (including legal fees) arising from your violation of these
                terms, your use of the service, or your content.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                You may delete your account at any time. Upon termination, we
                may retain your data as required by law.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                where Juzbuild operates. Any disputes shall be resolved through
                binding arbitration or in the courts of that jurisdiction, as
                applicable.
              </p>
            </section>
            ...
            <section className="bg-gradient-to-r from-orange-500/10 to-red-500/10 border border-orange-500/20 rounded-xl p-8 mt-12">
              ...
              <a
                href="mailto:legal@juzbuild.com"
