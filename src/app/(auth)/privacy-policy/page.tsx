          ...
          >
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                credentials, profile information, and communication preferences.
                We also automatically collect usage data, device information,
                and browsing behavior to improve our service and prevent fraud.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                Your information helps us personalize your experience, provide
                customer support, send important notifications, and comply with
                legal obligations.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                encryption, firewalls, and regular security audits. All
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                your data, we cannot guarantee absolute security. You are
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                trusted partners who assist us in operating our service, subject
                to confidentiality agreements. These include payment processors,
                analytics providers, and hosting providers.
              </p>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                features may be affected. We use both session and persistent
                cookies for legitimate business purposes.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                Juzbuild is not intended for individuals under 18 years of age.
                We do not knowingly collect personal information from children.
                If we become aware that a child has provided us with personal
                information, we will delete such information promptly and
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                be communicated via email or prominent notice on our website.
            ...
            <section className="bg-gradient-to-r from-green-500/10 to-blue-500/10 border border-green-500/20 rounded-xl p-8 mt-12">
              ...
              <p className="text-muted-foreground mb-6">
                If you have any concerns about our privacy practices or would
                like to exercise your rights, please contact our Data Protection
                Officer.
              </p>
              <a
                href="mailto:privacy@juzbuild.com"
