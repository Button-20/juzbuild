  ...
  const values = [
    {
      icon: Zap,
      title: "Innovation",
      description: "Cutting-edge solutions that keep real estate professionals ahead of the competition.",
      color: "from-blue-500 to-cyan-500",
    },
    {
      icon: Users,
      title: "Community",
      description: "Building a vibrant ecosystem where agents grow, share, and succeed together.",
      color: "from-purple-500 to-pink-500",
    },
    {
      icon: Globe,
      title: "Accessibility",
      description: "Professional tools accessible to everyone, regardless of technical experience or budget.",
      color: "from-green-500 to-emerald-500",
    },
  ];

  const timeline = [
    { year: "2020", title: "Founded", description: "Started with a vision to simplify real estate marketing" },
    { year: "2021", title: "First Users", description: "Launched beta with 500+ agents" },
    { year: "2022", title: "Major Growth", description: "Expanded to 3000+ active users" },
    { year: "2024", title: "Global Expansion", description: "Now serving 50+ countries worldwide" },
  ];
        ...
        <Container className="max-w-6xl relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Empowering real estate professionals to build stunning online presence and grow their business
            </p>
          </motion.div>
        </Container>
        </div>
      ...
      <Container className="max-w-4xl py-20">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            To democratize professional web presence for real estate professionals worldwide. We believe every agent 
            deserves access to enterprise-grade tools that help them succeed, regardless of their technical background 
            or budget.
          </p>
        </motion.div>
      </Container>
      ...
      <Container className="max-w-4xl py-20">
        ...
        >
          ...
          <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
            Join thousands of real estate professionals who are already building their online presence with Juzbuild.
          </p>
