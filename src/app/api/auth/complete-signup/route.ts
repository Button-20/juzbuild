...
export async function POST(request: NextRequest) {
  try {
    ...
    const websiteResponse = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/api/websites`, {
      method: 'POST',
      headers: {
    ...
    if (!websiteResponse.ok) {
      ...
      return NextResponse.json({
        ...
        message: 'Account created successfully. Website creation can be retried from dashboard.',
      });
    }
