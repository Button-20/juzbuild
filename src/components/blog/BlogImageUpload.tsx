...
export function BlogImageUpload({
  ...
  const getImageDimensions = () => {
    ...
    return "w-32 h-20 rounded-lg";
  };

  const getImagePreviewContainer = () => {
    if (type === "author") {
      return "relative w-20 h-20 mx-auto mb-2";
    }
    return "relative w-32 h-20 mx-auto mb-2";
  };
  ...
  return (
    <div className="space-y-4">
      <div className="grid w-full items-center gap-1.5">
        ...
        {value && (
          <div className={getImagePreviewContainer()}>
            <div
              className={`${getImageDimensions()} border-2 border-border overflow-hidden bg-muted`}
            >
              <Image
                src={value}
                alt={`${type} preview`}
                ...
                <div className="flex flex-col gap-0.5">
                  ...
                  <p className="text-xs text-muted-foreground">
                    {type === "cover"
                      ...
                      : "Recommended: Square image for profile"}
                  </p>
                  <p className="text-xs text-muted-foreground">
